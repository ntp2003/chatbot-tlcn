...
class UserDemand(str,Enum): # inherit from str n Enum 
...
class UserMemory(Base):
    ...
    # used_demand: Mapped[Optional[UserDemand]] = mapped_column(Text,nullable=True)
    user_demand: Mapped[UserDemand | None] = mapped_column(Text , nullable=True)
    prodcut_name: Mapped[str | None] = mapped_column(Text , nullable=True)
