...
from models.accessory import Accessory, AccessoryModel  # Cần tạo models/accessory.py
from sqlalchemy.sql.expression import and_
from sqlalchemy.sql.operators import OperatorType, ge, le, eq
from sqlalchemy.sql.elements import ColumnElement
from typing import Any, Generic, TypeVar
from repositories.accessory import search as search_accessory  # Cần tạo repositories/accessory.py
...
class FilterType(str, Enum):
    ...
    BRAND = "brand"
    NAME = "name"
    PRODUCT_TYPE = "product_type"  # Thêm category cho phụ kiện
